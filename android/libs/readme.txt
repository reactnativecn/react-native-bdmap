...
1、  修复某些情况下sug检索city、district为空；

2、  修复marker设置大尺寸图标，拖拽地图，marker点抖动的问题；

3、  修复批量添加maker点，未更新overlay的状态；

4、  修复setPadding的bug；

5、  修复某些情况下调起驾车导航数据解析失败的问题；

6、  修复设置瓦片图后，底图资源释放问题导致的纹理错乱问题；

7、  修复MapStatus解析过程偶现空指针；
